...
//This is my TestCenter page class. All objects ib TestCenter page will go here.
...
//Or Alternatively
//WebElement -->SelenideElement, there is no PageFactory
     ...
     public SelenideElement logOutLink = $(By.partialLinkText("Logout"));  // there was actually space
     ...
     public ElementsCollection allStates = $$(By.xpath("//select[@id='state']//option"));  //multiple elements
